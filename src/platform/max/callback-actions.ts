...
export type CallbackActionDefinition = Readonly<{ namespace: string; verb: string; requiresResource?: boolean; authorize?: (action: CallbackAction, principal: PortalPrincipal) => Promise<boolean> | boolean }>;
