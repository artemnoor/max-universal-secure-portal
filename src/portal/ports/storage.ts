...
export type AuditEventInput = Readonly<{ principal: PortalPrincipal; action: string; resourceType: string; resourceId?: string; metadata?: Readonly<Record<string, boolean | number | string | null>> }>;
