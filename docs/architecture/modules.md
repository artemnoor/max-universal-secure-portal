...
Nginx is an optional dumb proxy. TLS and secret injection are deployment responsibilities; Node remains authoritative for MAX Webhook secret validation, signed Mini App authentication, authorization, and rate limits.
